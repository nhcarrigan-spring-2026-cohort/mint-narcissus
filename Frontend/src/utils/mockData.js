export const MOCK_OUTFITS = [
  {
    ...
    imgSrc: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=15', // use an empty div or unsplash image link
    category: 'Formal',
    ...
    owner: { name: 'Sarah Johnson', img: 'https://i.pravatar.cc/150' },
    quote:
